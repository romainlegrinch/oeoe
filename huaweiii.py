        ...
        while True:
            for slice_obj in self.slices:
                while slice_obj.has_more_packets():
                    ...
                    if self.can_schedule_packet(current_packet, slice_obj, start_time):
                        ...
                        heapq.heappush(ready_packets, (current_packet.arrival_time, slice_obj.slice_id, current_packet.packet_id, current_packet))
                    else:
            ...
            for slice_obj, packet in delayed_packets:
                ...
                if self.can_schedule_packet(packet, slice_obj, start_time):
                    heapq.heappush(ready_packets, (packet.arrival_time, slice_obj.slice_id, packet.packet_id, packet))
                else:
            ...
            arrival_time, slice_id, packet_id, packet = heapq.heappop(ready_packets)
            transmission_time = self.calculate_transmission_time(packet.size)
            ...
            self.scheduled_packets.append((start_time, slice_id, packet_id))
